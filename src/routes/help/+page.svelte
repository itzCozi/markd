...
[example link](https://example.com)
    ...
    <div class="my-4">
      ...
      <p class="text-type-dimmed">
        Text styles are defined by wrapping the text in asterisks or underscores. Single asterisks
        is interpreted as italics, double asterisks is interpreted as bold, and triple asterisks is
...
- [x] Checked box
    ...
    <div class="my-4">
      ...
      <p class="text-type-dimmed">
        Strikethrough's are defined using <code>&#x7e;&#x7e;</code> symbols before and after the text
        you want to strikethrough, this is very useful for todo lists among other things.
      </p>
      <pre class="text-mono bg-mono-card p-3 my-1 rounded-sm text-wrap">
